					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>공개 여부</th>
								<td>
									<input type="radio" id="public" name="secret" value="no">
									<label for="public"></label>공개
									<input type="radio" id="private" name="secret" value="yes" checked>
							...
							<tr>
								<th>비고</th>
								<td>
									<textarea cols="10" class="form-control" name="content"></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="2">
